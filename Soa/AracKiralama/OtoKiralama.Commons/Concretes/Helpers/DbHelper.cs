...
namespace OtoKiralama.Commons.Concretes.Helpers
{
    ...
    public static class DBHelper
    {
        ...
        public static string GetConnectionString()
        {
            ...
            return ConfigurationManager.ConnectionStrings["Kiralama"].ConnectionString;
        }

        // Get connection provider from .config file.
        public static string GetConnectionProvider()
        {
            return ConfigurationManager.ConnectionStrings["Kiralama"].ProviderName;
        }
